...
#include "JhGameplayTags.h"
#include "JhLogChannels.h"
#include "GameplayTagsManager.h"

FJhGameplayTags FJhGameplayTags::GameplayTags;

void FJhGameplayTags::InitializeNativeTags()
{
	UGameplayTagsManager& Manager = UGameplayTagsManager::Get();
	GameplayTags.AddAllTags(Manager);
}

void FJhGameplayTags::AddTag(FGameplayTag& OutTag, const ANSICHAR* TagName, const ANSICHAR* TagComment)
{
	OutTag = UGameplayTagsManager::Get().AddNativeGameplayTag(FName(TagName), FString(TEXT("(Native) ")) + FString(TagComment));
}

void FJhGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
	/**
