...
#include "JhAssetManager.generated.h"

/**
 * 
 */
UCLASS()
class JHGAME_API UJhAssetManager : public UAssetManager
{
	GENERATED_BODY()
...
template <typename AssetType>
AssetType* UJhAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepsInMemory)
{
...
template <typename AssetType>
TSubclassOf<AssetType> UJhAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
